...
def crawl_level_satu(file, page, max_page, keyword):
...
file = "dataset/crawling/bfs_detik.csv"
page = 1
max_page = 100
crawl_level_satu(file, page, max_page, keyword)
crawl_level_dua(file)
drop_duplicate(file)
