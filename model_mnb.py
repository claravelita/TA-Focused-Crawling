...
def model_mnb(file_training, file_testing):
    ...
    for i in range(class_count_testing):
        ...
        cal_uw_y = (count_uw_y + 1) / (count_class_y + v)
        cal_pp_y = (count_pp_y + 1) / (count_class_y + v)
        cal_at_y = (count_at_y + 1) / (count_class_y + v)
        cal_st_y = (count_st_y + 1) / (count_class_y + v)
        ...
        cal_uw_n = (count_uw_n + 1) / (count_class_n + v)
        cal_pp_n = (count_pp_n + 1) / (count_class_n + v)
        cal_at_n = (count_at_n + 1) / (count_class_n + v)
        cal_st_n = (count_st_n + 1) / (count_class_n + v)
...
file_training = "dataset/testing_model_mnb/SK1/data_training_50%.csv"
file_testing = "dataset/testing_model_mnb/SK1/data_testing_kompas_50%.csv"
